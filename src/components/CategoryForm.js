...
const CategoryForm = ({
  ...
  const isEditMode = categoryData && categoryData.id;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        error.message ||
          `Error ${isEditMode ? "actualizando" : "creando"} categoría`
      );
    } finally {
      setLoading(false);
    }
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                variant="outlined"
                required
                placeholder="Ej: Perfumes Masculinos"
                sx={inputStyles}
              />
            </Grid>
